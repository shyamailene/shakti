...
public class RangoliResourceIntTest {
    ...
    public void setup() {
        ...
        final RangoliResource rangoliResource = new RangoliResource(rangoliRepository);
    ...
    public void createRangoli() throws Exception {
        ...
        assertThat(testRangoli.getSubdate()).isEqualTo(DEFAULT_SUBDATE);
    }
    ...
    public void updateRangoli() throws Exception {
        ...
        assertThat(testRangoli.getSubdate()).isEqualTo(UPDATED_SUBDATE);
    }
