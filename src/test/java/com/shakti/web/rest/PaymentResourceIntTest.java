...
import com.shakti.domain.Payment;
import com.shakti.repository.PaymentRepository;
...
public class PaymentResourceIntTest {
    ...
    private static final Integer DEFAULT_REL_ID = 1;
    private static final Integer UPDATED_REL_ID = 2;
    ...
    public void createPayment() throws Exception {
        ...
        assertThat(testPayment.getPaymentToken()).isEqualTo(DEFAULT_PAYMENT_TOKEN);
        ...
        assertThat(testPayment.getRelId()).isEqualTo(DEFAULT_REL_ID);
    }
    ...
    public void getAllPayments() throws Exception {
        ...
        restPaymentMockMvc.perform(get("/api/payments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].relId").value(hasItem(DEFAULT_REL_ID)));
    }
    ...
    public void getPayment() throws Exception {
        ...
        restPaymentMockMvc.perform(get("/api/payments/{id}", payment.getId()))
            ...
            .andExpect(jsonPath("$.relId").value(DEFAULT_REL_ID));
    }
    ...
    public void updatePayment() throws Exception {
        ...
        Payment testPayment = paymentList.get(paymentList.size() - 1);
        assertThat(testPayment.getPaymentToken()).isEqualTo(UPDATED_PAYMENT_TOKEN);
        ...
        assertThat(testPayment.getRelId()).isEqualTo(UPDATED_REL_ID);
    }
