    ...
    describe('Fundraiser Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/fundraisers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Fundraiser', () => {
                service.create(new Fundraiser(null)).subscribe(received => {
            ...
            it('should update a Fundraiser', () => {
                service.update(new Fundraiser(123)).subscribe(received => {
