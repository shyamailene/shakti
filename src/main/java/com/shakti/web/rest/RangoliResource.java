...
import com.shakti.repository.RangoliRepository;
...
public class RangoliResource {
    ...
    public RangoliResource(RangoliRepository rangoliRepository) {
    ...
    @Timed
    public ResponseEntity<Rangoli> createRangoli(@RequestBody Rangoli rangoli) throws URISyntaxException {
        ...
        Rangoli result = rangoliRepository.save(rangoli);
    ...
    @PutMapping("/rangolis")
    @Timed
    public ResponseEntity<Rangoli> updateRangoli(@RequestBody Rangoli rangoli) throws URISyntaxException {
    ...
    public ResponseEntity<Rangoli> getRangoli(@PathVariable Long id) {
        ...
        Optional<Rangoli> rangoli = rangoliRepository.findById(id);
